        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="index3.html" class="brand-link">
                    ...
                    <span class="brand-text font-weight-light">Rully Indra Permana</span>
                </a>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2023<a href="https://adminlte.io"> TRI - POLTEK AMAMAPARE</a>.</strong> All rights
                reserved.
            </footer>
        </div>
        <!-- ./wrapper -->
