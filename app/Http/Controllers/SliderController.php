...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Slider::create($input);
        return redirect('/sliders')->with('success','Data berhasil di Tambahkan');
    }
    ...
    public function update(Request $request, Slider $slider)
    {
        ...
        $slider->update($input);
        return redirect('/sliders')->with('success','Data berhasil di Edit');
    ...
    {
        $slider->delete();
        return redirect('/sliders')->with('success','Data Berhasil di Hapus');
    }
}
